...
public class Route {
    ...
    static String LANGUAGE_POLISH = "pl";
    ...
    private class connectAsyncTask extends AsyncTask<Void, Void, String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            CommonFunctions.showMessageToast("Processing...", Toast.LENGTH_SHORT);
        }
        @Override
    ...
    private void drawPath(String  result, boolean withSteps) {
        ...
        try {
            ...
            MapsActivity.setRoute(routes);
            CommonFunctions.showRouteParams();
